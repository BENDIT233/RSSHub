...
//上海立信会计金融学院
router.get('/slu/tzgg', require('./routes/universities/slu/tzgg'));
router.get('/slu/jwc', require('./routes/universities/slu/jwc'));
router.get('/slu/tyyjkxy', require('./routes/universities/slu/tyyjkxy'));
